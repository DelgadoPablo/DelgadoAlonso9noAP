...
import { IEquipo } from 'src/common/interfaces/student.interface';
...
export class StudentController {
  ...
  @Post()
  create(@Body() studentDTO: StudentDTO): Observable<IEquipo> {
  ...
  @Put(':id')
  update(@Param('id') id: string, @Body() studentDTO: StudentDTO): Observable<IEquipo> {
